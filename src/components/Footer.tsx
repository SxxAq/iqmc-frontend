...
const navigation = {
  ...
  industries: [
    ...
    { name: "Food & Agriculture", href: "/industries/food-agriculture" },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img className="h-12" src="/iqmc-logo-white.png" alt="IQMC India" />
            <p className="text-sm leading-6 text-gray-300">
              Guiding Growth, Driving Success through Quality Management and
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; 2023 IQMC India. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
